...
VENDORED_PATCHES = [
    "accumulators", "asio", "beast", "config_platform", "config_user", "hof",
    "io", "lambda", "mqtt5", "multi_array", "parameter", "range_adaptors",
    "regex", "safe_numerics", "serialization", "system", "test", "ublas",
    "units",
]
